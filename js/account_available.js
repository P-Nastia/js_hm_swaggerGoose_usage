...
function ChangeMenu() {
    ...
    <a href="/pages/admin/adminPanel.html">
        ...
        userNav.innerHTML = `
<a href="/pages/login.html" style="margin-right:5px" class="block py-2 px-3 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 text-lg">Login</a>
            <a href="/pages/register.html" style="margin-left:5px" class="block py-2 px-3 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 text-lg">Register</a>
                    `;
    }
